package com.jingxiang.versionupdate.view.widget;
...
//        view.setPadding(0, 0, 0, 0);
    ...
    public void windowDeploy(int x, int y, int width) {
        ...
        if (width <= 0) {
            width = CommonHelper.dpToPx(mContext, 280);
        } else {
            width = CommonHelper.dpToPx(mContext, width);
        }
